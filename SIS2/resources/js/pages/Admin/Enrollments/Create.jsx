...
export default function Create({ students, courses }) {
    const { data, setData, post, processing, errors } = useForm({
        student_id: '', course_id: '', semester: '', school_year: '', status: 'enrolled',
    })
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 max-w-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="e.g. 2024-2025" value={data.school_year} onChange={e => setData('school_year', e.target.value)}
                            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
